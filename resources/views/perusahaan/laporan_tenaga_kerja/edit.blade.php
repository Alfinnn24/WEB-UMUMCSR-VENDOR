...
<div class="row">
    <div class="col-xl-7 mx-auto">
        <form action="{{ route('perusahaan.laporan-tenaga-kerja.update', $rec->id) }}" method="POST" id="formLaporan">
            @csrf
            @method('PUT')
                ...
                <div class="card-body">
                    <div class="border p-4 rounded">
                        <div class="card-title d-flex align-items-center gap-2">
                            <i class="bx bxs-file-doc font-22 text-warning"></i>
                            <h5 class="mb-0">Edit Data Laporan Tenaga Kerja</h5>
                        </div>
                        <hr />
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="nomor_surat" class="form-control"
                                       value="{{ $rec->nomor_surat }}" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-0">
                            ...
                            <div class="col-sm-8">
                                <input type="date" name="tgl_laporan" class="form-control"
                                       value="{{ $rec->tgl_laporan }}" required>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-3 rounded mb-4 d-flex align-items-center gap-3" style="background-color: #dcfce7; border: 1px solid #bbf7d0; color: #166534;">
                ...
                <div class="flex-grow-1">
                    <strong>File Laporan Tersedia</strong><br>
                    <small>{{ $rec->file_laporan }}</small>
                </div>
                <a href="/uploads/laporan_tenaker/{{ $rec->file_laporan }}"
